...
class RunAction : public G4UserRunAction
{
  ...
  public:
    ...
    void AddHitMatches()  {fNbHitMatches++;};
    void AddEvtWithHitMatches()  {fNbEvtWithHitMatches++;};

    void AddStubs()  {fNbStubs++;};
    void AddEvtWithStubs()  {fNbEvtWithStubs++;};
  ...
  private:
    ...
    G4int    fNbCoinc;
    G4int    fNbHitMatches, fNbEvtWithHitMatches;
    G4int    fNbStubs, fNbEvtWithStubs;
